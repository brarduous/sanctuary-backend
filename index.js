...
const studyDeliveriesRouter = require('./routes/studyDeliveries');
...
app.use('/api', studyDeliveriesRouter);
...
app.use('/api/v1', studyDeliveriesRouter);
