...
async function evaluate() {
    ...
    for (const config of EVAL_CONFIG) {
        ...
        const judgeSystemPrompt = `
            ...
            3. Provide a combined CRITIQUE. Be specific about where generated output succeeds or fails against the selected metadata and user-facing options.
            4. Suggest a BETTER PROMPT to improve quality and consistency. It must include the key elements from the original prompt, especially the return format to ensure that the output is always as expected. Preserve JSON output requirements.
