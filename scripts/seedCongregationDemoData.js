...
const main = async () => {
  ...
  const events = [
    ...
    { id: stableUuid('event:newcomer-lunch'), congregation_id: TARGET_CONGREGATION_ID, title: 'Newcomer Lunch', description: 'Meet ministry leaders and learn how to connect.', event_type: 'fellowship', event_date: nextWeekday(0, 12, 1), end_time: nextWeekday(0, 13, 30, 1), location: 'Fellowship Hall', status: 'published', organizer_id: user.id, is_public: true, capacity: 40, follow_up_status: 'not_started' },
  ];
